...
/*
 * Buffer for ungetch. Changing the buffer array to hold integers will
 * suffice to handle EOF (EOF value is -1 and if we convert it to char
 * and back again we may not get -1 but a positive value instead
 */
int buf[BUFSIZE]; 
